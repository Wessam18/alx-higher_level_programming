...
$VIRTUAL_ENV = r"/root/alx-higher_level_programming/0x0F-python-object_relational_mapping/myenv"

$_OLD_VIRTUAL_PATH = $PATH
$PATH = $PATH[:]
$PATH.add($VIRTUAL_ENV + _get_sep() + "local/bin", front=True, replace=True)
